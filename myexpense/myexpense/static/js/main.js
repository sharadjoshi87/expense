function Calculate() {
  ...
  var shobhit_class = table.getElementsByClassName('shobhit');
  ...
  var scC = document.getElementById('shobhitCount');
  ...
  var shobhitCount = shobhit_class.length
  ...
  for (var i = 0; i < shobhit_class.length; i++)
    shobhit_delta += parseInt(shobhit_class[i].value);

  var max = Math.max(aman_delta, anand_delta, anil_delta, prashant_delta, rahul_delta, sharad_delta, shobhit_delta)
  ...
  console.log('shobhit delta: ' + shobhit_delta);
  var output = document.getElementById('shobhit_delta');
  var contri = document.getElementById('shobhit_cont');
  output.innerHTML = '<strong>&#x20B9; ' + (max - shobhit_delta) + '</strong>';
  contri.innerHTML = '<strong>&#x20B9; ' + shobhit_delta + '</strong>';
  ...
  scC.textContent = shobhitCount + 'x';

  delta_sum = (max - anand_delta) + (max - aman_delta) + (max - anil_delta) + (max - rahul_delta) + (max - prashant_delta) + (max - sharad_delta) + (max - shobhit_delta);
